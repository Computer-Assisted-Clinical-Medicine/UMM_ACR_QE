function RootVector = MatrixLineRoot2Vector( Matrix, xIndexVector, yIndexVector )
    ...
    NumOfRoots  = length(xIndexVector);
    RootVector = [];
    
    for Index = 1 : NumOfRoots - 1
        RootVector = [RootVector(1 : end - 1),  MatrixLine2Vector( Matrix, ...
