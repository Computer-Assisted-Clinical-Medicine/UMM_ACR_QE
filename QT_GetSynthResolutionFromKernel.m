function W_cross = QT_GetSynthResolutionFromKernel( Sigma_val, F )
...
I_G_num = @(W,Sigma)erf(sqrt(2.0).*W.*sqrt(1.0./Sigma.^2).*(1.0./2.0)).*1.0./sqrt(1.0./Sigma.^2).*1.0./sqrt(Sigma.^2);

%numerical evaluation
W_val       = 0 : 0.01 : 10 * Sigma_val;
I_G_val     = 1-I_G_num(W_val,Sigma_val);

W_ind       = find( I_G_val < F,1,'first');
