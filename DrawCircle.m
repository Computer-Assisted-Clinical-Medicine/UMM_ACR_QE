function DrawCircle( CenterX, CenterY, Radius, Color )
    ...
    %Method Description:
    %
    %Simple drawing method to plot a circle centered at CenterX/CenterY,
    %with a certain radius and plottet with a certain color

    t = 0:0.1:2*pi;
    x = Radius * cos(t);
    y = Radius * sin(t);
    plot(x + CenterX, y + CenterY, 'Linewidth', 2, 'Color', Color)
    line([x + CenterX(1), x + CenterX(end)], [y + CenterY(1), y + CenterY(end)], 'Linewidth', 2, 'Color', Color)
