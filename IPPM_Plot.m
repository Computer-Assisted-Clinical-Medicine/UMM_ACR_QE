function IPPM_Plot( RealXY, IdealXY, FigHandle )
    ...
    %Method Description:
    %-------------------
    %plot both ideal and measure point clouds to current figure
    ...
    for Index = 1 : NumOfPoints
        RealHandle   = plot(RealXY(Index,1), RealXY(Index,2), 'X','Linewidth',2,'Color','blue');
        IdealHandle  = plot(IdealXY(Index,1),IdealXY(Index,2),'O','Linewidth',2,'Color','red');
    end
    legend([RealHandle, IdealHandle], 'Real Grid', 'Ideal Grid')
