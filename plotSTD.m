function Return = plotSTD(x,y,STD,Marker,MarkerSize,Color)
    ...
    switch STDstyle
        case 1
            Return = [nan nan nan];
            STDColor = 'blue';
            Return(1) = plot(x,y,'Marker',Marker,'Color',Color,'LineWidth',MarkerSize);
            Return(2) = plot(x,y - STD,'Marker','^','Color',STDColor,'LineWidth',2);
            Return(3) = plot(x,y + STD,'Marker','v','Color',STDColor,'LineWidth',2);
        case 2
            Return = [nan nan];
            Return(1) = errorbar(x,y,STD);
            Return(2) = plot(x,y,Marker,'Color',Color,'LineWidth',MarkerSize);
